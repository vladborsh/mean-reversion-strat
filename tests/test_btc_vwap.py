"""
Test script for BTC VWAP Mean Reversion Strategy

This script validates the VWAP detector by:
1. Fetching historical BTC data from Capital.com for a specified date range
2. Running the detector on each eligible candle (14:00-16:00 UTC)
...
class BTCVWAPTester:
    """
    Test harness for BTC VWAP Mean Reversion strategy.
    """
    ...
    def __init__(self, strategy_config: dict):
        ...
        self.detector = VWAPDetector(
            ...
            signal_window_start=strategy_config.get('signal_window_start', '14:00'),
            signal_window_end=strategy_config.get('signal_window_end', '16:00'),
    ...
    def run_backtest(self, data: pd.DataFrame, symbol: str = 'BTC') -> List[Dict]:
        """
        ...
        for i in range(min_required, len(data)):
            ...
            # Only analyze during signal window (14:00-16:00 UTC)
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("=" * 80)
        report.append("BTC VWAP MEAN REVERSION STRATEGY - BACKTEST REPORT")
        report.append("=" * 80)
        report.append("")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Test BTC VWAP Mean Reversion Strategy',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Test for December 2025 (using default config)
  python tests/test_btc_vwap.py --start 2025-12-01 --end 2025-12-24 --symbol BTC
  
  # Test with custom config file
  python tests/test_btc_vwap.py --start 2025-12-01 --end 2025-12-24 --symbol BTC --config my_config.json
  
  # Export signals to CSV
  python tests/test_btc_vwap.py --start 2025-12-01 --end 2025-12-24 --symbol BTC --export signals.csv
        """
    )
    ...
    # Initialize tester
    try:
        tester = BTCVWAPTester(strategy_config=strategy_params)
